...
#include "../Casco_DMIor/DialogVersion.h"
...
QT_MOC_LITERAL(1, 14, 17), // "signalRefreshMute"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 17), // "on_btn_ok_clicked"
QT_MOC_LITERAL(4, 51, 27), // "on_volumeslider_sliderMoved"
QT_MOC_LITERAL(5, 79, 8) // "position"

    },
    "DialogVersion\0signalRefreshMute\0\0"
    "on_btn_ok_clicked\0on_volumeslider_sliderMoved\0"
    "position"
};
...
void DialogVersion::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signalRefreshMute(); break;
        case 1: _t->on_btn_ok_clicked(); break;
        case 2: _t->on_volumeslider_sliderMoved((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (DialogVersion::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DialogVersion::signalRefreshMute)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject DialogVersion::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_DialogVersion.data,
      qt_meta_data_DialogVersion,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *DialogVersion::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DialogVersion.stringdata0))
        return static_cast<void*>(const_cast< DialogVersion*>(this));
...
// SIGNAL 0
void DialogVersion::signalRefreshMute()
{
